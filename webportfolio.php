...
<div id="wrapper" class="clearfix">
    ...
    <div class="main-content-area">
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="title text-white" style="text-transform: uppercase">Website portfolio</h2>
                  ...
                  <span class="trail-item trail-begin">
                    <a href="#"><span>Home</span></a>
                                    ...
                                    <span class="trail-item"><a
                                            href="#"><span>Website Portfolio</span></a></span>
                                </div>
                            </nav>
                        </div>
                    </div>
        ...
        <!--webpage content section starts-->
        <section>
            <div class="container pt-4">
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-6 col-xl-6">
                        <div class="image-box tilt-hover-effect mb-50">
                            <img src="images/web_portfolio/img1.png" alt="Web Development">
                            <img class="floating-img1" src="images/web_portfolio/img2.png"
                                 alt="Webdevelopment">
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6 col-xl-6">
                        ...
                        <p class="lead">Choose from a variety of designs for your new daycare website! We've taken the
                            hard work out of coming up with professional, attractive, modern website layouts for
                            businesses like yours. You just need to choose a template and a package to get started.</p>
                        <a href="Contact"
