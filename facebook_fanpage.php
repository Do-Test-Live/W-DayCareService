                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="title text-white" style="text-transform: uppercase">Facebook Fan page</h2>
                  ...
                  <span class="trail-item trail-begin">
                    <a href="#"><span>Home</span></a>
                                    ...
                                    <span class="trail-item"><a
                                                href="#"><span>Facebook Fan Page</span></a></span>
                                </div>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-7 col-xl-7">
                        <div class="image-box mb-50">
                            <img src="images/facebook_fanpage/img1.png" alt="">
                            <img class="floating-img1" src="images/facebook_fanpage/img2.png" alt="">
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-5 col-xl-5">
                        <h2 class="text-theme-colored1">Facebook <span
                                    class="text-theme-colored2">Fan Page </span>Design
                        </h2>
                        <p>Your Facebook Fan Page to your infant care commercial enterprise must replicate your logo and
                            identity. Instead of displaying widespread photos, use the profile photo and banner photo to
                            characteristic and spotlight your emblem and photos out of your website. This will put into
                            effect your logo and hold your advertising and marketing consistent. We will create custom
                            banner and profile photo designs to your Facebook web page to higher constitute your
                            commercial enterprise and entice extra inquiries.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="tm-sc-section-title section-title text-center">
                                <div class="title-wrapper">
                                    <h2 class="title text-theme-colored1">Facebook Fan Page Design Templates</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col"></div>
