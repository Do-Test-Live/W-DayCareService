                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="title text-white" style="text-transform: uppercase">Facebook Banner</h2>
                  ...
                  <span class="trail-item trail-begin">
                    <a href="#"><span>Home</span></a>
                                    ...
                                    <span class="trail-item"><a
                                                href="#"><span>Facebook Banner</span></a></span>
                                </div>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-7 col-xl-7">
                        <div class="image-box mb-50">
                            <img src="images/facebook_banner/img1.png" alt="">
                            <img class="floating-img1" src="images/facebook_banner/img2.png" alt="">
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-5 col-xl-5">
                        <h2 class="text-theme-colored1">Facebook Banner <span
                                    class="text-theme-colored2">Post Templates</span>
                        </h2>
                        <p class="lead">Need a few assist together along with your Facebook advertising efforts? We have
                            listened to our child care customers and created pre-designed templates to assist market
                            your enterprise on Facebook.</p>
                        <p>(More will be added regularly, so stay tuned in to Facebook for updates!) Also, note that we
                            also create custom childcare profiles and timeline header graphics for your Facebook
                            Business Page.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="tm-sc-section-title section-title text-center">
                                <div class="title-wrapper">
                                    <h2 class="title text-theme-colored1">Facebook Banner Post Templates</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col"></div>
