                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="title text-white" style="text-transform: uppercase">business card &
                                stationary</h2>
                  ...
                  <span class="trail-item trail-begin">
                    <a href="#"><span>Home</span></a>
                                    ...
                                    <span class="trail-item"><a
                                                href="#"><span>Business Card & Stationary</span></a></span>
                                </div>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12 col-lg-5 col-xl-5">
                        <h2 class="text-theme-colored1">Business Card & <span
                                    class="text-theme-colored2">Stationary </span>Design
                        </h2>
                        <p>Our graphic design artists can create art for your all of your child care marketing needs. We
                            have created artwork for child care businesses for digital and print including:
                        <ul>
                            <li class="theme-colored-before">Business Cards</li>
                            <li class="theme-colored-before">Promotional Banners</li>
                            <li class="theme-colored-before">Stationery and Envelopes</li>
                            <li class="theme-colored-before">Displays and Banners</li>
                            <li class="theme-colored-before">Tri-Fold Brochures</li>
                            <li class="theme-colored-before">Double-sided postcard mailers</li>
                            <li class="theme-colored-before">Facebook Cover Photo Design</li>
                            <li class="theme-colored-before">Facebook Digital Banner & Promotional Ads</li>
                        </ul>
                        Custom online advertising campaigns
                        Please contact us to inquire about our child care graphic design services and we would be happy
                        to provide you with a custom quote.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="tm-sc-section-title section-title text-center">
                                <div class="title-wrapper">
                                    <h2 class="title text-theme-colored1">Business Card & Stationary Template</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col"></div>
