                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="title text-white" style="text-transform: uppercase">Logo Design</h2>
                  ...
                  <span class="trail-item trail-begin">
                    <a href="#"><span>Home</span></a>
                                    ...
                                    <span class="trail-item"><a
                                                href="#"><span>Logo Design Process</span></a></span>
                                </div>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12 col-lg-5 col-xl-5">
                        <h2 class="text-theme-colored1">The Logo <span class="text-theme-colored2">Design Process</span>
                        </h2>
                        <p class="lead">Whether you would like US to style a replacement web site for your business or
                            not, we will design a professional, custom brand design for your kid care business. we've
                            been making custom, high-quality logos for our clients for over ten years and you'll review
                            a number of our styles below.</p>
                        <p>First, we ask you to fill out a logo design questionnaire that allows you to provide feedback
                            on the style, elements, and characteristics of the design. After going through the
                            questionnaire with our logo design team, we'll go over any questions or clarifications we
                            need. answered before you start with the concepts. Once we are 100% clear on the design
                            direction, we start with your new concepts. It usually takes us 3-5 business days to create
                            5-6 new and unique concepts for you to choose from. We offer </p>
                        <p>Unlimited revisions of the chosen concept until you are 100% satisfied with the final logo.
                            In the final file logo pack, you get all the logo files you need for all your marketing
                            needs, including the source file and the logo. Font files.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="tm-sc-section-title section-title text-center">
                                <div class="title-wrapper">
                                    <h2 class="title text-theme-colored1">Child Care Logo Design Portfolio</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col"></div>
