    ...
    <div class="main-content-area">
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="title text-white">Graphic Design</h2>
                  ...
                  <span class="trail-item trail-begin">
                    <a href="#"><span>Home</span></a>
                                    ...
                                    <span class="trail-item"><a href="#"><span>Graphic Design</span></a></span>
                                </div>
                            </nav>
                        </div>
                    </div>
        ...
        <section>
            <div class="container">
                <div class="section-content">
                    <div class="row">
                        <h2 class="text-center">GRAPHIC DESIGN SERVICES FOR CHILD CARE CENTERS & PRESCHOOLS.
                        </h2>
                        <!-- Section: About -->
                        <section>
                            <div class="container pt-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-12 col-lg-6 col-xl-6">
                                        <h2 class="text-theme-colored1">Parents Are Talking… <span
                                                class="text-theme-colored2">Are You Part Of The Conversation?</span>
                                        </h2>
                                        <p class="lead">Over 80 percent of parents do research online when trying to
                                            find a center for their child. How does your center’s reputation look? More
                                            important, are you aware of all the places that parents are talking? If not,
                                            you need to make sure you are part of the conversation.</p>
                                        <a href="Contact"
                        ...
                        <section>
                            <div class="container pt-0">
                                <div class="row align-items-center">
                                    <div class="col-md-12 col-lg-6 col-xl-6">
                                        <h2 class="text-theme-colored1">How Can <span
                                                class="text-theme-colored2">Local Child Care Marketing</span> Help
                                            You?
                                        </h2>
                                        <p class="lead">Your online reputation is too important to leave it to chance.
                                            You must have a system working for you so you can leverage technology and
                                            gain 5 Star online reviews. Our reputation marketing system will give you an
                                            advantage in the marketplace when it comes to reviews.</p>
                                        <p class="lead">We will specifically do 2 things for you.<br>
                                            1. Give You Strategies To Get More 5 Star Reviews Online<br>
                                            2. Turn each of those reviews into marketing assets that are always working
                                            for you<br>
                                            We gather reviews using our proprietary feedback systems, we help get those
                                            reviews online in an ethical way, and then we turn those reviews into
                                            marketing pieces that consist of social media postings, videos, content for
